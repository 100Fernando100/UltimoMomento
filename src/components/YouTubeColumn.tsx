  ...
  return (
    <section className="w-full">
      <div className="flex items-center gap-3 mb-5 pb-3" style={{ borderBottom: '2px solid #cc0000' }}>
        ...
        <span className="font-oswald font-700 text-white uppercase tracking-wider text-sm">CANAL OFICIAL</span>
        ...
        {videos.map((video, i) => (
          <div key={video.id} className="group">
            ...
            <div className="pt-2">
              ...
              <h3 className="font-anton text-white text-sm leading-tight group-hover:text-red-400 transition-colors">
                {video.title}
              </h3>
              <p className="font-oswald text-gray-500 text-xs mt-1 uppercase tracking-wider">{video.views}</p>
            </div>
          </div>
        ))}
      </div>
